...
export default function UserBadge({ user }) {
  ...
  return (
    ...
    >
      ...
      {menu && (
        <motion.div
          className="absolute top-[48px] right-0 bg-input-bg dark:bg-dark-input-bg border border-input-border dark:border-dark-input-border h-fit min-w-[150px] w-[200px] xl:w-full z-[70] rounded-main shadow-lg flex flex-col gap-8 p-8"
