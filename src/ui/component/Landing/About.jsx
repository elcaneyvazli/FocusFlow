    ...
    <div className="grid grid-cols-2 xl:grid-cols-3 gap-16">
      ...
      <div className="flex flex-col gap-16 items-start border border-input-border dark:border-dark-input-border bg-input-bg dark:bg-dark-input-bg rounded-main p-16 col-span-2 sm:col-span-1">
        ...
        <div className="flex flex-col gap-0">
          <h1 className="text-black dark:text-input-bg text-2xl">Master Your Time</h1>
      ...
      <div className="flex flex-col gap-16 items-start border border-input-border dark:border-dark-input-border bg-input-bg dark:bg-dark-input-bg rounded-main p-16 col-span-2 sm:col-span-1">
        ...
        <div className="flex flex-col gap-0">
          <h1 className="text-black dark:text-input-bg text-2xl">Unlock Data-Driven Insights</h1>
          <p className="text-light text-lg">
      ...
      <div className="flex flex-col gap-16 items-start border border-input-border dark:border-dark-input-border bg-input-bg dark:bg-dark-input-bg rounded-main p-16 col-span-2 sm:col-span-1">
        ...
        <div className="flex flex-col gap-0">
          <h1 className="text-black dark:text-input-bg text-2xl">Ignite Your Focus Flame</h1>
          <p className="text-light text-lg">
      ...
      <div className="flex flex-col gap-16 items-start border border-input-border dark:border-dark-input-border bg-input-bg dark:bg-dark-input-bg rounded-main p-16 col-span-2 sm:col-span-1">
        ...
        <div className="flex flex-col gap-0">
          <h1 className="text-black dark:text-input-bg text-2xl">Eliminate Distractions</h1>
          <p className="text-light text-lg">
