...
export default function OnlyViewCalendar({
  ...
  return (
    <div className="absolute z-50 h-[300px] w-full mt-[10px] dark:bg-primary bg-white rounded-main border border-input-border dark:border-dark-input-border grid grid-cols-7 grid-rows-7 gap-12 p-12 top-40">
