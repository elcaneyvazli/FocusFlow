      ...
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-col gap-4">
          <div className="flex flex-row items-center gap-8">
            ...
            <div className="bg-success-100 border border-success-600 flex items-center justify-center rounded-full py-4 px-12">
              <ArrowUp className="text-success-600" size={12} />
              <p className="text-success-600 text-xs font-medium leading-none">
                {percentage}%
              </p>
            </div>
          </div>
